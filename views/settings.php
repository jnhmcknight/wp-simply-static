			...
			<table class='form-table'>
				<tbody>
					...
					<tr>
						...
						<td>
							<select name='delivery_method' id='deliveryMethod'>
								<option value='s3' <?php Util::selected_if( $this->delivery_method === 's3' ) ?>><?php _e( "S3 Bucket", 'simply-static' ); ?></option>
					...
					<tr class='delivery-method s3'>
						<th></th>
						<td>
							<p><?php _e( "Saving your static files to an S3 bucket is useful for quickly publishing your site to an inexpensive, worldclass delivery system. After generating your static files, they will be uploaded to your bucket and available for viewing.", 'simply-static' ); ?></p>
						</td>
					</tr>
               <tr class='delivery-method s3'>
                  <th>
